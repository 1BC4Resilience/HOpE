...
function getMarkupFromData(dataForSingleItem) {
  ...
  if (validated !== 'Yes') {
    return null;
      ...
      return [  
      '<figure class="col-6@xs col-4@sm col-4@md picture-item" data-groups="[' + tagsList + ']" ',
...
function appendMarkupToPage(markup) {
  var addNewOpportunities = [
      '<figure id="starter-card" class="col-6@xs col-4@sm col-4@md picture-item shuffle-item shuffle-item--visible" data-groups="[\'all\']" data-date-created="2025-08-27" data-title="Add your own new opportunity here!">',
      ...
      ' <div class="aspect__inner">      <img src="./img/Start-animated_gif.gif"> ',   
      '  </div> ', 
      '  </div> ',
